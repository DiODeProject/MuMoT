...
# -*- coding: utf-8 -*-
#
# MuMoT documentation build configuration file, created by
# sphinx-quickstart on Thu Dec 14 17:49:51 2017.
#
...
latex_documents = [
    (master_doc, 'MuMoT.tex', 'MuMoT Documentation',
     'James A. R. Marshall, Andreagiovanni Reina, Thomas Bose\'', 'manual'),
]
...
man_pages = [
    (master_doc, 'mumot', 'MuMoT Documentation',
     [author], 1)
]
