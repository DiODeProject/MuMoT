...
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000047}{Todo}]\+: add to {\bfseries init}() \end{DoxyRefDesc}
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000048}{Todo}]remove magic number \end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000039}{Todo}]\+: not yet supported) \end{DoxyRefDesc}
