...
\item[\hyperlink{todo__todo000065}{Todo}]Deprecated method to be removed \end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000066}{Todo}]check if it is still running correctly after structural change for View independence from Controller (especially, if initial\+State is correctly initialised) \end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000068}{Todo}]moving it to general method? \end{DoxyRefDesc}
